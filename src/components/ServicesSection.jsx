    ...
    const services = [
        {
            icon: FaBuilding,
            title: 'Construction',
            description: 'End-to-end construction solutions for residential and commercial projects with precision and excellence.',
            color: 'from-primary-500 to-accent',
        },
        {
            icon: FaRoad,
            title: 'Infrastructure',
            description: 'Building robust infrastructure including roads, bridges, and utilities that serve communities.',
            color: 'from-navy-600 to-navy-800',
        },
        {
            icon: FaTools,
            title: 'Renovation',
            description: 'Transform existing spaces with modern renovations that breathe new life into structures.',
        ...
        },
        {
            ...
            description: 'Comprehensive urban planning and development solutions for smart, sustainable cities.',
