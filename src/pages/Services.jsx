    ...
    const services = [
        {
            ...
            description: 'Complete construction services for residential and commercial buildings. From foundation to finishing, we handle every aspect with precision and care.',
            features: ['Residential Complexes', 'Commercial Buildings', 'Industrial Facilities', 'Institutional Structures'],
            color: 'from-primary-500 to-accent',
        },
        {
            icon: FaRoad,
            title: 'Infrastructure Development',
            description: 'Building the backbone of modern society with roads, bridges, and essential infrastructure that connects and serves communities.',
            features: ['Road Construction', 'Bridge Engineering', 'Urban Infrastructure', 'Utility Networks'],
            color: 'from-navy-600 to-navy-800',
        },
        {
            icon: FaTools,
            title: 'Renovation & Remodeling',
            description: 'Transform existing spaces with our expert renovation services. We breathe new life into structures while preserving their character.',
            features: ['Interior Renovation', 'Exterior Upgrades', 'Structural Modifications', 'Modern Retrofitting'],
            color: 'from-emerald-500 to-emerald-700',
        },
        {
            icon: FaDraftingCompass,
            title: 'Architectural Design',
            description: 'Innovative architectural solutions that blend aesthetics with functionality. Our designs inspire and endure.',
            features: ['Concept Development', '3D Visualization', 'Sustainable Design', 'Interior Planning'],
            color: 'from-violet-500 to-violet-700',
        },
        {
            icon: FaHardHat,
            title: 'Project Management',
            description: 'Expert oversight ensuring your project is delivered on time, within budget, and to the highest specifications.',
            features: ['Timeline Management', 'Budget Control', 'Quality Assurance', 'Risk Mitigation'],
            color: 'from-amber-500 to-amber-700',
        },
        {
            icon: FaCity,
            title: 'Urban Planning',
            description: 'Comprehensive urban development solutions for smart, sustainable, and livable cities of tomorrow.',
            features: ['Master Planning', 'Township Development', 'Smart City Solutions', 'Environmental Planning'],
            color: 'from-cyan-500 to-cyan-700',
        },
        {
            icon: FaCog,
            title: 'MEP Services',
            description: 'Mechanical, Electrical, and Plumbing services that ensure your building operates efficiently and safely.',
        ...
        },
        {
            ...
            description: 'Sustainable construction practices that minimize environmental impact while maximizing efficiency and comfort.',
            features: ['LEED Certification', 'Solar Integration', 'Rainwater Harvesting', 'Energy Efficiency'],
